...
public class Client implements ActionListener {
    ...
    Client(){
        ...
        p1.setBounds(0,0,450,70);//To pass coordinate.
        p1.setLayout(null);
        f.add(p1);
        ...
        a1 = new JPanel();
        a1.setBounds(0,70,450,503);
        a1.setBackground(Color.GRAY);
        f.add(a1);

        text = new JTextField();
        text.setBounds(5,570,310,30);
        text.setFont(new Font("ARIAL_BOLD", Font.ITALIC,16));
        f.add(text);

        JButton send = new JButton("Send");
        send.setBounds(332,570,85,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try {
            ...
            //p2.add(output);
            //p2.setFont(new Font("ARIAL_BOLD", Font.ITALIC,16));
    ...
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(137, 229, 174));
